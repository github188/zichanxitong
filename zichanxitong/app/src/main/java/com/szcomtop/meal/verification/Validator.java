...
package com.szcomtop.meal.verification;
...
import com.szcomtop.meal.verification.annotation.Checked;
import com.szcomtop.meal.verification.annotation.ConfirmPassword;
import com.szcomtop.meal.verification.annotation.Email;
import com.szcomtop.meal.verification.annotation.IpAddress;
import com.szcomtop.meal.verification.annotation.NumberRule;
import com.szcomtop.meal.verification.annotation.Password;
import com.szcomtop.meal.verification.annotation.Regex;
import com.szcomtop.meal.verification.annotation.Required;
import com.szcomtop.meal.verification.annotation.Telphone;
import com.szcomtop.meal.verification.annotation.TelphoneOrEmail;
...
public class Validator {
	...
	private boolean isSaripaarAnnotation(Annotation annotation) {
		...
		return annotationType.equals(Checked.class) || annotationType.equals(ConfirmPassword.class) || annotationType.equals(Email.class) || annotationType.equals(IpAddress.class) || annotationType.equals(NumberRule.class) || annotationType.equals(Password.class) || annotationType.equals(Regex.class) || annotationType.equals(Required.class) || annotationType.equals(TextRule.class) || annotationType.equals(TelphoneOrEmail.class) || annotationType.equals(Telphone.class);
	}
	...
	private class AnnotationFieldPairCompartor implements Comparator<AnnotationFieldPair> {
		...
		private int getAnnotationOrder(Annotation annotation) {
			...
			} else if (annotatedClass.equals(Telphone.class)) {
				return ((Telphone) annotation).order();
			} else if (annotatedClass.equals(TelphoneOrEmail.class)) {
				return ((TelphoneOrEmail) annotation).order();
			} else {
